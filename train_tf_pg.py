...
register(
    id='ModelBasedCartPoleFromPGPolicy-e-v0',
    entry_point='gym_model_cartpole.model:ModelBasedCartPoleEnv',
    kwargs={
      'name':'cartpolefrompg',
      #'sstates_filename':'random.sstates.csv',
      'sstates_filename':'pg_start_states.csv',
      'model_filename':'model_pg_1.0.h5',
...
#ENV_NAME_TRAIN = 'ModelBasedCartPoleFromDQNPolicy-v0'
ENV_NAME_TRAIN = 'ModelBasedCartPoleFromPGPolicy-e-v0'
#ENV_NAME_TRAIN = 'ModelBasedCartPoleFromDQNPolicy-v0'
